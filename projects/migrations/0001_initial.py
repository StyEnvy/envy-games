# Generated by Django 5.1.11 on 2025-09-05 23:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board_type', models.CharField(choices=[('kanban', 'Kanban'), ('roadmap', 'Roadmap')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('planning', 'Planning'), ('active', 'Active'), ('hold', 'On Hold'), ('completed', 'Completed'), ('archived', 'Archived')], default='planning', max_length=20)),
