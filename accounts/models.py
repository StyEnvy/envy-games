...
class Profile(models.Model):
    ...
    role = models.CharField(max_length=8, choices=UserRole.choices, default=UserRole.DEVELOPER)
...
def ensure_profile_exists(sender, instance: User, created: bool, **kwargs):
    """
    Make sure every User always has a Profile. If admins create a user, the profile is created too.
    """
    if created:
